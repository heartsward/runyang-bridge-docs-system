...
from app.utils.timezone_utils import BeijingDateTime
...
class Asset(Base):
    ...
    # 时间戳
    created_at = Column(BeijingDateTime, server_default=func.now(), comment="创建时间")
    updated_at = Column(BeijingDateTime, server_default=func.now(), onupdate=func.now(), comment="更新时间")
