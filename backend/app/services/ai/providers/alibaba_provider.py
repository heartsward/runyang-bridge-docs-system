...
class AlibabaProvider(BaseAIProvider):
    """阿里云通义提供商适配器"""
    ...
    def get_available_models(self) -> List[AIModelInfo]:
        """获取可用模型列表"""
        return [
            AIModelInfo("qwen-plus", 32000, 0.0002, 0.0006),
            AIModelInfo("qwen-turbo", 8000, 0.00008, 0.0002),
            AIModelInfo("qwen-max", 8000, 0.0002, 0.0006),
        ]
