...
class ZhipuProvider(BaseAIProvider):
    ...
    def get_available_models(self) -> List[AIModelInfo]:
        """获取可用模型列表"""
        return [
            AIModelInfo("glm-4", 128000, 0.001, 0.002),
            AIModelInfo("glm-4-flash", 128000, 0.00015, 0.0006),
            AIModelInfo("glm-4-air", 128000, 0.0001, 0.0005),
            AIModelInfo("glm-3-turbo", 128000, 0.00005, 0.0002),
        ]
